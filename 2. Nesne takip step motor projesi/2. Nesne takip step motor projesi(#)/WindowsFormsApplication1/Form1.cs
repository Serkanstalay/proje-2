...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        {
            MessageBox.Show("Bu proje Serkan Suleyman Talay'a aittir. " + Environment.NewLine + "18.12.2018");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Finalvideo.DesiredFrameSize = new Size(1200, 600);//görüntü boyutları
            Finalvideo.Start();
        }
            ...
            if (rdiobtnTekCisimTakibi.Checked)
            {
                ...
                foreach (Rectangle recs in rects)
                {
                    if (rects.Length > 0)
                    {
                        ...
                        //Dikdörtgenin Koordinatlari aliniyor.
                        ...
                        if (objectX >= 0 && objectX <= 400 && objectY >=0 && objectY <=600 )
                        {
                            ardino.Write("1");
                        }
                        else if (objectX > 400 && objectX <= 800 && objectY >= 0 && objectY <= 600)
                        {
                            ardino.Write("2");
                        }
                        else if (objectX > 800 && objectY < 1200 && objectY >= 0 && objectY <= 600)
                        {
                            ardino.Write("3");
                        }
